                        ...
                        <form method="POST" action="{{ route('employer.settings.password') }}" id="pwdForm" novalidate>
                            ...
                            @if (session('password_updated'))
                                <div class="emp-notice success" style="margin-bottom:16px;"><i
                                        class="fas fa-check-circle"></i> Password updated successfully!</div>
                            @endif

                            <div class="f-group">
                                <label class="f-label" for="current_password"><i class="fas fa-key"></i> Current Password
                                    <span class="f-req">*</span></label>
                                <div class="f-iw" style="position:relative;">
                                    <i class="fas fa-key f-ico"></i>
                                    <input type="password" id="current_password" name="current_password" class="f-input"
                                        placeholder="Enter current password" />
                                    <button type="button" onclick="togglePwd('current_password',this)"
                                        style="position:absolute;right:12px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:var(--gray-400);font-size:.82rem;">
                            ...
                            <div class="f-group">
                                <label class="f-label" for="new_password"><i class="fas fa-lock"></i> New Password <span
                                        class="f-req">*</span></label>
                                <div class="f-iw" style="position:relative;">
                                    <i class="fas fa-lock f-ico"></i>
                                    <input type="password" id="new_password" name="new_password" class="f-input"
                                ...
                                <div class="pwd-hint" id="pwdHint" style="color:var(--gray-400);">Enter a password to
                                    check strength</div>
                            </div>

                            <div class="f-group">
                                <label class="f-label" for="new_password_confirmation"><i class="fas fa-check-double"></i>
                                    Confirm New Password <span class="f-req">*</span></label>
                                <div class="f-iw" style="position:relative;">
                                    <i class="fas fa-check-double f-ico"></i>
                                    <input type="password" id="new_password_confirmation" name="new_password_confirmation"
                                        class="f-input" placeholder="Repeat new password" oninput="checkPwdMatch()" />
                                </div>
                                <div class="f-err" id="pwdMatchErr"><i class="fas fa-circle-exclamation"></i> Passwords do
                                    not match.</div>
                            </div>

                            <div style="margin-top:6px;">
                                <div class="f-hint" style="margin-bottom:10px;"><i class="fas fa-shield-check"></i> Use a
                                    mix of letters, numbers and symbols for a strong password</div>
                                <button type="submit" class="btn-primary"><i class="fas fa-lock"></i> Update
                                    Password</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="emp-card-body">
                        <form method="POST" action="{{ route('employer.settings.notifications') }}">
                            ...
                            <div class="emp-divider">
                                ...
                                <div class="emp-divider-lbl"><i class="fas fa-envelope"></i> Email Notifications</div>
                                <div class="emp-divider-line"></div>
                            </div>
                            ...
                            <div class="emp-divider">
                                <div class="emp-divider-line"></div>
                                <div class="emp-divider-lbl"><i class="fas fa-mobile-alt"></i> SMS Notifications</div>
                                <div class="emp-divider-line"></div>
                            </div>

                            @php $smsNotifs = [['name' => 'sms_new_application', 'title' => 'New Application SMS', 'desc' => 'Receive SMS for each new job application'], ['name' => 'sms_plan_expiry', 'title' => 'Plan Expiry SMS', 'desc' => 'SMS reminder before your plan expires']]; @endphp
                            ...
                            <div style="margin-top:20px;">
                                <button type="submit" class="btn-primary"><i class="fas fa-floppy-disk"></i> Save
                                    Preferences</button>
                            </div>
                        </form>
                    </div>
            ...
            <div class="settings-section" id="section-danger">
                <div class="emp-card">
                    <div class="emp-card-head" style="background:linear-gradient(135deg,#dc2626,#b91c1c);">
                        <div class="emp-card-head-ico" style="background:rgba(255,255,255,.15);"><i
                    ...
                    <div class="emp-card-body">
                        <div class="danger-zone">
                            ...
                            <div class="dz-desc">
                                Permanently delete your employer account and all associated data including job postings,
                                candidate applications, billing history, and company profile. <strong>This action cannot be
                                    undone.</strong>
                            </div>
                            ...
                            <button class="btn-outline btn-sm" style="color:var(--red);border-color:#fca5a5;"
                            ...
                            <div class="delete-confirm" id="deleteConfirm">
                                <form id="deleteAccountForm">
                                    ...
                                    <div style="font-size:.82rem;font-weight:700;color:var(--red);margin-bottom:10px;">
                                        <i class="fas fa-triangle-exclamation"></i> Type <strong>DELETE</strong> to
                                        confirm:
                                    </div>
                                    <div class="f-group" style="margin-bottom:12px;">
                                        <input type="text" name="confirm_text" class="f-input no-ico"
                                            placeholder="Type DELETE here" oninput="checkDeleteConfirm(this.value)" />
                                    </div>

                                    <div class="f-group" style="margin-bottom:12px;">
                                        <label class="f-label" for="delete_password"><i class="fas fa-lock"></i> Enter
                                            Password</label>
                                        <div class="f-iw">
                                            <i class="fas fa-lock f-ico"></i>
                                            <input type="password" id="delete_password" name="password" class="f-input"
                                    ...
                                    <div style="display:flex;gap:8px;">
                                        ...
                                        <button type="submit" class="btn-primary btn-sm" id="deleteAccountBtn" disabled
...
@push('scripts')
    ...
    form.addEventListener('submit', function(e) {
        ...
        const confirm_text = this.confirm_text.value;
        ...
        formData.append('d_message', 'User requested account deletion');

        fetch("{{ route('employer.settings.delete') }}", {
            method: 'POST',
            body: formData,
        })
        .then(res => res.json())
        ...
        function checkPwdStrength(pwd) {
            ...
            hint.textContent = score > 0 ? 'Password strength: ' + (labels[score] || '') :
