...
@push('styles')
    ...
    ══════════════════════════════════════════════════════ */
        ...
        .cp-notice.success .cp-notice-ico {
            background: linear-gradient(135deg, #059669, #10b981);
            color: #fff;
            box-shadow: 0 2px 8px rgba(5, 150, 105, .3);
        }

        .cp-notice.info .cp-notice-ico {
    ...
    ══════════════════════════════════════════════════════ */
        ...
        .cp-tab-addr.active {
            background: linear-gradient(135deg, #ecfdf5, #d9fbe9);
            color: #059669;
            border-color: #a7f3d0;
        }

        .cp-tab-addr.active i {
            color: #059669;
        }

        .cp-tab-contact.active {
            background: linear-gradient(135deg, #f5f3ff, #ede9fe);
            color: #7c3aed;
            border-color: #ddd6fe;
        }

        .cp-tab-contact.active i {
            color: #7c3aed;
        }

        .cp-tab-verify.active {
            background: linear-gradient(135deg, #fff7ed, #fef3c7);
            color: #d97706;
            border-color: #fde68a;
        }

        .cp-tab-verify.active i {
            color: #d97706;
        }
    ...
    ══════════════════════════════════════════════════════ */
        ...
        .cp-card-hdr-green {
            background: linear-gradient(135deg, #f0fdf7, #e6faf1);
        }
    ...
    ══════════════════════════════════════════════════════ */
        ...
        .f-input.is-error:focus {
            box-shadow: 0 0 0 3.5px rgba(220, 38, 38, .12);
        }
    ...
    ══════════════════════════════════════════════════════ */
        ...
        .cp-btn-save:hover {
            transform: translateY(-2px);
            box-shadow: 0 6px 20px rgba(26, 86, 219, .42);
        }
...
@section('content')
    <div class="cp-page">
        ...
        <div class="cp-notice success">
            ...
            <div>
                <strong>Verification Approved!</strong> Your company has been verified by the LinearJobs team on <strong>10
                    Mar 2025</strong>.
                    ...
                    <div class="cp-card-body">
                                ...
                                <div class="f-group">
                                    ...
                                    <div class="f-iw">
                                        ...
                                        <input type="text" id="company_name" name="company_name" class="f-input"
                                            value="{{ old('company_name', $employer->employerDetails->company_name ?? 'TechBridge Solutions Pvt. Ltd.') }}"
                                            placeholder="Legal company name" />
                                    </div>
                                    <div class="f-hint"><i class="fas fa-circle-info"></i> Use the full legal name exactly
                                        as registered with MCA / GST</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="f-group">
                            ...
                            <div class="f-iw">
                                ...
                                <textarea id="description" name="company_description" class="f-input" style="padding-left:38px;min-height:120px;"
                            ...
                            <div class="f-hint"><i class="fas fa-circle-info"></i> A good description helps candidates
                                understand your company culture</div>
                        </div>
                                ...
                                <div class="f-iw">
                                    ...
                                    <select id="industry_type" name="industry_type" class="f-input">
                                        ...
                                        @foreach ($industries as $ind)
                                            <option value="{{ $ind }}"
                                                {{ ($employer->industry_type ?? 'IT / Software') === $ind ? 'selected' : '' }}>
                                                {{ $ind }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="f-iw">
                                    ...
                                    <select id="company_size" name="company_size" class="f-input">
                                        @foreach (['1-10', '11-50', '51-200', '201-500', '501-1000', '1000+'] as $s)
                                            <option value="{{ $s }}"
                                                {{ ($employer->company_size ?? '51-200') === $s ? 'selected' : '' }}>
                                                {{ $s }} Employees</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="f-iw">
                                    ...
                                    <select id="founded_year" name="founded_year" class="f-input">
                                        @for ($y = date('Y'); $y >= 1950; $y--)
                                            <option value="{{ $y }}"
                                                {{ ($employer->founded_year ?? 2019) === $y ? 'selected' : '' }}>
                                                {{ $y }}</option>
                                        @endfor
                                    </select>
                                </div>
                    ...
                    <div class="cp-card-body">
                        ...
                        <div class="f-group">
                            ...
                            <div class="f-iw">
                                ...
                                <textarea id="address" name="company_address" class="f-input" style="padding-left:38px;min-height:80px;"
                                ...
                                <div class="f-iw">
                                    ...
                                    <select id="state" name="state" class="f-input">
                                        @foreach (['Tamil Nadu', 'Kerala', 'Karnataka', 'Andhra Pradesh', 'Telangana'] as $st)
                                            <option value="{{ $st }}"
                                                {{ ($employer->state ?? 'Tamil Nadu') === $st ? 'selected' : '' }}>
                                                {{ $st }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="f-group">
                                ...
                                <div class="f-iw">
                                    ...
                                    <select id="district" name="district" class="f-input">
                                        ...
                                        @foreach ($dists as $d)
                                            <option value="{{ $d }}"
                                                {{ ($employer->district ?? 'Chennai') === $d ? 'selected' : '' }}>
                                                {{ $d }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="f-group">
                                ...
                                <div class="f-iw">
                                    ...
                                    <input type="text" id="city" name="city" class="f-input"
                                        value="{{ old('city', $employer->city ?? 'Chennai') }}"
                        ...
                        <div class="f-group" style="max-width:220px;">
                            ...
                            <div class="f-iw">
                                ...
                                <input type="text" id="pincode" name="pincode" class="f-input"
                                    value="{{ old('pincode', $employer->pincode ?? '600040') }}" maxlength="6"
                            ...
                            <div class="f-group">
                                ...
                                <div class="f-iw">
                                    ...
                                    <input type="text" id="owner_name" name="owner_name" class="f-input"
                                        value="{{ old('owner_name', $employer->employerDetails->owner_name ?? 'Karthik Selvan') }}"
                            ...
                            <div class="f-group">
                                ...
                                <div class="f-iw">
                                    ...
                                    <input type="tel" id="owner_mobile" name="owner_mobile" class="f-input"
                                        value="{{ old('owner_mobile', $employer->employerDetails->owner_mobile ?? '+91 98765 43210') }}"
                            ...
                            <div class="f-group">
                                ...
                                <div class="f-iw">
                                    ...
                                    <input type="text" id="hr_name" name="hr_name" class="f-input"
                                        value="{{ old('hr_name', $employer->employerDetails->hr_name ?? 'Preethi Raj') }}"
                            ...
                            <div class="f-group">
                                ...
                                <div class="f-iw">
                                    ...
                                    <input type="tel" id="hr_mobile" name="hr_mobile" class="f-input"
                                        value="{{ old('hr_mobile', $employer->employerDetails->hr_mobile ?? '+91 98765 11111') }}"
                                        placeholder="+91 XXXXX XXXXX" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="f-group">
                            ...
                            <div class="f-iw">
                                ...
                                <input type="email" id="official_email" name="official_email" class="f-input"
                                    value="{{ old('email', $employer->employerDetails->email ?? 'hr@techbridge.in') }}"
                                    placeholder="company@domain.com" />
                            </div>
                            <div class="f-hint"><i class="fas fa-circle-info"></i> Candidates may use this email to
                                contact you</div>
                        </div>
                ...
                <div class="cp-card">
                    ...
                    <div class="cp-card-body">
                        ...
                        <div
                            ...
                            <div>
                                <div class="f-label" style="margin-bottom:8px;"><i class="fas fa-circle-check"></i>
                            ...
                            <div class="f-group">
                                ...
                                <div class="f-iw">
                                    <input type="text" class="f-input no-ico is-valid"
                                        value="{{ $employer->employerDetails->gst ?? '33AABCT1234A1Z5' }}" readonly />
                                </div>
                            </div>
                            <div class="f-group">
                                ...
                                <div class="f-iw">
                                    <input type="text" class="f-input no-ico is-valid"
                                        value="{{ $employer->employerDetails->pan ?? 'AABCT1234A' }}" readonly />
                                </div>
                            </div>
                            <div class="f-group">
                                ...
                                <div class="f-iw">
                                    <input type="text" class="f-input no-ico is-valid"
                                        value="{{ $employer->employerDetails->msme_number ?? 'TN/03/0012345' }}"
                                        readonly />
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="display:flex;flex-direction:column;gap:10px;">
                            ...
                            @php
                                $docs = [
                                    [
                                        ...
                                        'file' => $employer->employerDetails->gst_certificate ?? null,
                                        'ico' => 'fa-file-pdf',
                                        'cls' => 'doc-ico-red',
                                    ],
                                    [
                                        'name' => 'PAN Card',
                                        'file' => $employer->employerDetails->pan_document ?? null,
                                        'ico' => 'fa-id-card',
                                        'cls' => 'doc-ico-blue',
                                    ],
                                    [
                                        'name' => 'MSME Certificate',
                                        'file' => $employer->employerDetails->msme_certificate ?? null,
                                        'ico' => 'fa-certificate',
                                        'cls' => 'doc-ico-green',
                                    ],
                                ];
                            ...
                            @foreach ($docs as $doc)
                                @if ($doc['file'])
                                    <div class="doc-row">
                                        <div class="doc-ico {{ $doc['cls'] }}">
                                            <i class="fas {{ $doc['ico'] }}"></i>
                                        </div>
                                        ...
                                        <!-- ✅ VIEW BUTTON -->
                                        <a href="{{ asset('public/uploads/employer/' . $doc['file']) }}" target="_blank"
                                            class="doc-view-btn">
            ...
            error: function (xhr) {
                ...
                if (xhr.status === 422) {
                    ...
                    $.each(errors, function (key, value) {
                        $('[name="' + key + '"]').after(
                            '<span class="error-text text-danger">' + value[0] + '</span>'
                        );

                        // 🔴 Show first error in toaster
