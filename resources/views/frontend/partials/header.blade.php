...
<header class="lj-nav" id="ljNav">
  <div class="lj-wrap lj-nav-inner">
    ...
    <ul class="lj-nav-links">
      ...
      <li class="{{ request()->routeIs('post-job') ? 'lj-cur' : '' }}">
    ...
    <div class="lj-nav-right">
      @guest
        ...
        <a href="{{ route('post-job') }}" class="lj-btn lj-btn-green">Post a Job</a>
      @else
...
<nav class="lj-drawer" id="ljDrawer" aria-label="Mobile navigation">
  <a href="{{ route('home') }}"        class="lj-drawer-link {{ request()->routeIs('home') ? 'lj-drawer-cur' : '' }}">Home</a>
  <a href="{{ route('jobs.index') }}"  class="lj-drawer-link {{ request()->routeIs('jobs.*') ? 'lj-drawer-cur' : '' }}">Find Jobs</a>
  <a href="{{ route('post-job') }}"    class="lj-drawer-link {{ request()->routeIs('post-job') ? 'lj-drawer-cur' : '' }}">Post a Job</a>
  <a href="{{ route('pricing') }}"     class="lj-drawer-link {{ request()->routeIs('pricing') ? 'lj-drawer-cur' : '' }}">Pricing</a>
  <a href="{{ route('contact') }}"     class="lj-drawer-link {{ request()->routeIs('contact') ? 'lj-drawer-cur' : '' }}">Contact</a>
  ...
  @guest
    <div class="lj-drawer-btns">
      ...
      <a href="{{ route('post-job') }}"           class="lj-btn lj-btn-green lj-btn-w" style="background:var(--green-h);">Post a Job</a>
    </div>
  @else
    <div class="lj-drawer-btns">
