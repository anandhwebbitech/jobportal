...
@push('styles')
  ...
  ═══════════════════════════════════════════════════ */
    ...
    .left-panel.blue {
      background: linear-gradient(150deg, #1a56db 0%, #1e3a8a 100%);
    }
    ...
    .rp-logo.green-mode .rp-logo-ico {
    ...
    .type-btn.js-btn::before {
      background: linear-gradient(135deg, rgba(26, 86, 219, .05), rgba(30, 58, 138, .06));
    }

    .type-btn.emp-btn::before {
      background: linear-gradient(135deg, rgba(5, 150, 105, .05), rgba(6, 95, 70, .06));
    }
    ...
    .type-btn.js-btn:hover {
      border-color: rgba(26, 86, 219, .3);
    }

    .type-btn.emp-btn:hover {
    ...
    .type-btn.active-js .type-ico {
      background: var(--blue);
      color: #fff;
      transform: scale(1.08) rotate(-4deg);
    }

    .type-btn.active-green .type-ico {
    ...
    .type-btn.active-js .type-name {
      color: var(--blue);
    }

    .type-btn.active-green .type-name {
      color: var(--green);
    }
    ...
    .type-btn.active-js .type-check {
      background: var(--blue);
      opacity: 1;
      transform: scale(1);
    }

    .type-btn.active-green .type-check {
      background: var(--green);
      opacity: 1;
      transform: scale(1);
    }
    ...
    .finput.blue-focus:focus {
      border-color: var(--blue);
      box-shadow: 0 0 0 3px rgba(26, 86, 219, .1);
    }

    .finput.green-focus:focus {
      border-color: var(--green);
      box-shadow: 0 0 0 3px rgba(5, 150, 105, .1);
    }
    ...
    <div class="split">
      ...
      <div class="left-panel blue" id="leftPanel">
        ...
        <div id="lpJs" class="fade-in">
          ...
          <div class="lp-sub">Connect with verified MSME employers and take the next step in your career — completely
            free.</div>
          <div class="lp-perks">
            <div class="lp-perk">
              <div class="lp-perk-ico"><i class="fa-solid fa-briefcase"></i></div>
              <div class="lp-perk-text"><strong>10,000+ Job Listings</strong>Browse opportunities across all industries
                and districts.</div>
            </div>
            <div class="lp-perk">
              <div class="lp-perk-ico"><i class="fa-solid fa-shield-halved"></i></div>
              <div class="lp-perk-text"><strong>Verified Employers</strong>All companies are GST & PAN verified for your
                safety.</div>
            </div>
            <div class="lp-perk">
              <div class="lp-perk-ico"><i class="fa-solid fa-indian-rupee-sign"></i></div>
              <div class="lp-perk-text"><strong>100% Free for Job Seekers</strong>No fees, no subscriptions. Apply to
                unlimited jobs.</div>
            </div>
            <div class="lp-perk">
              <div class="lp-perk-ico"><i class="fa-solid fa-bell"></i></div>
              <div class="lp-perk-text"><strong>Instant Job Alerts</strong>Get notified the moment matching jobs are
                posted.</div>
            </div>
          </div>
          <div class="lp-stats">
            <div>
              <div class="lp-stat-val">50,000+</div>
              <div class="lp-stat-lbl">Job Seekers</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div class="lp-stat-lbl">Free</div>
            </div>
          </div>
        </div>
        ...
        <div id="lpEmp" style="display:none" class="fade-in">
          ...
          <div class="lp-sub">Post jobs and connect with thousands of skilled professionals across Tamil Nadu — starting
            at just ₹600.</div>
          <div class="lp-perks">
            <div class="lp-perk">
              <div class="lp-perk-ico"><i class="fa-solid fa-users"></i></div>
              <div class="lp-perk-text"><strong>Large Talent Pool</strong>Access 50,000+ registered job seekers across all
                skills.</div>
            </div>
            <div class="lp-perk">
              <div class="lp-perk-ico"><i class="fa-solid fa-tag"></i></div>
              <div class="lp-perk-text"><strong>Affordable Plans</strong>Post jobs from ₹600. Plans designed for MSMEs.
              </div>
            </div>
            <div class="lp-perk">
              <div class="lp-perk-ico"><i class="fa-solid fa-map-location-dot"></i></div>
              <div class="lp-perk-text"><strong>Local Hiring Focus</strong>Reach candidates in all 32 districts of Tamil
                Nadu.</div>
            </div>
            <div class="lp-perk">
              <div class="lp-perk-ico"><i class="fa-solid fa-chart-line"></i></div>
              <div class="lp-perk-text"><strong>Easy Dashboard</strong>Manage all applications from one simple dashboard.
              </div>
            </div>
          </div>
          <div class="lp-stats">
        ...
        <form id="loginForm" onsubmit="handleSubmit(); return false;">
          ...
          <div class="fgroup">
            ...
            <div class="fiw">
              ...
              <input type="password" id="f_password" name="password" class="finput has-right blue-focus"
  ...
  <script>
    ...
    function selectType(type) {
      ...
      `;
        ...
        document.getElementById('switchBottom').innerHTML = `
        New employer? <a href="{{ route('jobseeker.register') }}" class="green">Register Your Company</a>
        <div class="switch-divider"></div>
